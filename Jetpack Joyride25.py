...
def FinalSpin():
    ...
    if not mute:
        pygame.mixer.init()
        spinningsound= pygame.mixer.Sound("Img1/spin/spinning.wav")
        waitingsound=[False, 0]
        winsound= pygame.mixer.Sound("Img1/spin/win.wav")
        stopsound= pygame.mixer.Sound("Img1/spin/stop.wav")
        stopsound.set_volume(.3)
    spinsleft=pygame.image.load(r"Img1\spin\spins left.png")
    ...
    prizes=[]
    prizesurf=[]
    prizesurfn=[r"Img1\spin\3 spin tokens.png", r"Img1\spin\double coins.png", r"Img1\spin\stack of coins.png", r"Img1\spin\speed.png", r"Img1\spin\1 coin.png", r"Img1\spin\heart.png", r"Img1\spin\3 coins.png"]
#    prizesurfn=[r"Img1\spin\speed.png"]
    ...
    lightsurface=[pygame.image.load(r"Img1\spin\red light.png"), pygame.image.load(r"Img1\spin\grey light.png"), pygame.image.load(r"Img1\spin\grey light.png"), pygame.image.load(r"Img1\spin\grey light.png"), pygame.image.load(r"Img1\spin\grey light.png")]
            ...
            if spinspeed==[0, 0, 0]:
                ...
                if waitframes<=0:
                    if winners[1:] == winners[:-1]:
                        ...
                        elif winners[0]==r"Img1\spin\spinspeed.png":
                            speed=20
                            print("sped you up!")
    ...
    if not mute:
        spinningsound.stop()
    spintokens=0
    print("the fps is:", round(1000/(sum(fps)/len(fps)), 3))


def firstscreen():
    global ralt, lalt, f4
    global font, distf
    first=pygame.image.load("Img1/first screen.png")
...
def outlineit(x, y, outline, size, string, font, color, most):
    ...
    for i in string:
        ...
        if i !=" ":
            ...
            x+=most
try:
    pygame.mixer.music.load("Img1/Jetpack Joyride Music.wav")
except:
    try:
        pygame.mixer.music.load("Img1/Jetpack Joyride Music smaller.wav")
    except:
...
def thestash():
    global ralt, lalt, f4
    global stash, screen
    stash = pygame.image.load("Img1/the stash.png")
    end = False
    while end == False:
        ...
        for event in ev:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pos[0]>55 and pos[0]<155 and pos[1] >5 and pos[1]<68:
                    ...
                    screen.blit(pygame.image.load("Img1/screenshot.bmp"), (0, 0))
                    screen.blit(pygame.image.load("Img1/darker screen.png"),(0,0))
...
def main():
    ...
    mainmenu = pygame.image.load("Img1/newmain.png")
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pos[0]>525 and pos[0]<974 and pos[1] >528 and pos[1]<685:
                    ...
                    while clickout == False:
                        credit = pygame.image.load("Img1/main credits.png")
                    ...
                    screen.blit(pygame.image.load("Img1/darker screen.png"),( 0,0))
                    while clickout == False:
                        instruction = pygame.image.load("Img1/main instruction.png")
...
def Quit():
    ...
    steve=pygame.image.load("Img1\dead.png")
    ...
    while e:
        e=0
        try:
            pygame.image.save(screen, "Img1/screenshot.bmp")
        except:
            e=1

    ss=pygame.image.load("Img1/screenshot.bmp")
    c=0
    Imgg=steve
    ...
    while m<=floor:
        ...
        m=stevey
    screen.blit(ss, (0, 0))
    steve=pygame.image.load("Img1\end.png")
...
class Zapper():
    ...
    x, y = 0, 0
    rotate = False
    image = random.choice(["Img1/zap2.png", "Img1/zap3.png", "Img1\zap.png", "Img1\zap1.png"])
    Object = pygame.image.load(image)
    spinObj = pygame.image.load("Img1\zap4.png")
    ...
    def randompic(self):
        self.image = random.choice(["Img1/zap2.png", "Img1/zap3.png", "Img1\zap.png", "Img1\zap1.png"])#, "Img1\zap4.png"])
        if  self.image == "Img1\zap4.png":
            self.rotate = True
        else:
            self.rotate = False
    ...
    def intersecting(self, steverect):
        ...
        if ourrect.colliderect( steverect ) and not invincible:
            if (self.image == "Img1/zap2.png" or self.image == "Img1/zap3.png"):
    ...
    def __init__(self):
        self.x, self.y = 0, 0
        self.image = random.choice(["Img1/zap2.png", "Img1/zap3.png", "Img1\zap.png", "Img1\zap1.png"])
        self.Object = pygame.image.load(self.image)
        self.rect = self.Object.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y
...
class Coin():
    ...
    imgnum = 0
    for i in range(6):
        imgs.append(pygame.image.load("Img1/Coin"+str(i)+"1.png"))
    CoinObject = imgs[imgnum]
    rect = CoinObject.get_rect()
    rect.x = x
    rect.y = y
    spintoken=False
    spintokenimage=pygame.image.load(r"Img1\spin\spin token.png")
    def __init__(self):
...
########################################################################################OPEN IMAGES!!!!!!!!!!!#####################################################################################
################################################################################################################################################################################################
bg1 = pygame.image.load("Img1/bg6.jpg")
bg2 = pygame.image.load("Img1/bg6.jpg")
pause = pygame.image.load("Img1/pause.png")

highscore = open('Img1/Highscore.txt', 'r+')
...
try:
    money = int(open('Img1/money.txt', 'r').readlines()[0])
except:
    money = 0
    open('Img1/money.txt', 'w').write("0")
pause.set_colorkey(pygame.Color(0, 0, 0))
paused = pygame.image.load("Img1/paused.png")
font = pygame.font.Font("Img1/New Athletic M54.ttf", 50)
smallfont = pygame.font.Font("Img1/New Athletic M54.ttf", 40)
verysmallfont = pygame.font.Font("Img1/New Athletic M54.ttf", 30)
extremefont = pygame.font.Font("Img1/New Athletic M54.ttf", 130)
steve = pygame.image.load("Img1/walk1.png")
darker = pygame.image.load("Img1/darker screen.png")
moneytxt = open('Img1/money.txt', 'w')

steveimages = [pygame.image.load("Img1/walk1.png"), pygame.image.load("Img1/walk2.png"), pygame.image.load("Img1/flying1.png"), pygame.image.load("Img1/beggining.png")]
...
##        pygame.mixer.music.unpause()
    ...
    while die != True:
        ...
        if ifpause == False and not die:
            ...
            for i in range(len(coins)):
                coins[i].blit()
            if invincibleframesl%4==invincibleframesl%2:
                screen.blit(steve, (stevex, stevey))
            else:
                print("hidden")
            screen.blit(pause, (width-pause.get_width(), 0))
...
#########################################################################################################################
            ...
            while ifpause == True:
                ...
                if mute:
                    muteObj = pygame.image.load("Img1/mute.png")
                else:
                    muteObj = pygame.image.load("Img1/unmute.png")
